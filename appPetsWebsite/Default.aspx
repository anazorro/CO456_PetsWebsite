...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <!-- This main section is composed by text, an image and an accordion which allows to toggle between hiding and showing large amount of content -->
    <main>
        <section>
        ...
        <section class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
            ...
            <article class="panel panel-default">
                <header class="panel-heading" role="tab" id="headingOne">
                    <h4 class="panel-title">
                        <a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne">Dog Accessories
                        </a>
                    </h4>
                </header>
            ...
            <article class="panel panel-default">
                <header class="panel-heading" role="tab" id="headingTwo">
                    <h4 class="panel-title">
                        <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">Cat Accessories
                        </a>
                    </h4>
                </header>
            ...
            <article class="panel panel-default">
                <header class="panel-heading" role="tab" id="headingThree">
                    <h4 class="panel-title">
                        <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseThree" aria-expanded="false" aria-controls="collapseThree">Dog Bedding
                        </a>
                    </h4>
                </header>
            ...
            <article class="panel panel-default">
                <header class="panel-heading" role="tab" id="headingFour">
                    <h4 class="panel-title">
                        <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseFour" aria-expanded="false" aria-controls="collapseFour">Health & Hygiene
                        </a>
                    </h4>
                </header>
            ...
            <article class="panel panel-default">
                <header class="panel-heading" role="tab" id="headingFive">
                    <h4 class="panel-title">
                        <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseFive" aria-expanded="false" aria-controls="collapseFive">Bird Cages, Food & More
                        </a>
                    </h4>
                </header>
            ...
            <article class="panel panel-default">
                <header class="panel-heading" role="tab" id="headingSix">
                    <h4 class="panel-title">
                        <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseSix" aria-expanded="false" aria-controls="collapseSix">Crates & Training Accessories
                        </a>
                    </h4>
                </header>
